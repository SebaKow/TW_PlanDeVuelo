	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
			  <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Vuelo</h5>
			</div>
			<div class="modal-body">
				¿Está seguro que desea eliminar el vuelo: ${vueloAEliminar.origen} - ${vueloAEliminar.destino}?
			</div>
			<div class="modal-footer">
				<a class="btn btn-lg btn-primary font-weight-bold" href="vuelos" role="button">Cancelar</a>
				<form action="eliminarVueloDeLista" method="GET">
