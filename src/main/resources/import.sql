...
insert into planDeVuelo (descripcion, fechaString, fecha, estado, avion_id) values ("PDV1", "2019-11-18 06:00:00", '2019-11-18 06:00:00', b'1', 1);
insert into planDeVuelo (descripcion, fechaString, fecha, estado, avion_id) values ("PDV2", "2019-12-07 08:00:00", '2019-12-07 08:00:00', b'1', 2);
insert into planDeVuelo (descripcion, fechaString, fecha, estado, avion_id) values ("PDV3", "2019-12-10 10:00:00", '2019-12-10 10:00:00', b'1', 3);
insert into planDeVuelo (descripcion, fechaString, fecha, estado, avion_id) values ("PDV4", "2019-12-11 14:00:00", '2019-12-11 14:00:00', b'1', 4);
