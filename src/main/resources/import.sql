...
insert into itinerario_vuelo (itinerarios_id, vuelos_id) values (2, 2);
insert into itinerario_vuelo (itinerarios_id, vuelos_id) values (3, 3);
insert into itinerario_vuelo (itinerarios_id, vuelos_id) values (4, 4);
